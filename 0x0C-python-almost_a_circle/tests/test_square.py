...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_is_Base_instance(self):
        """ checks if square is base instance """
        new = Square(1)
    ...
    def test_area(self):
        """ checks area method return value """
        new = Square(4)
        self.assertEqual(new.area(), 16)

    def test_load_from_file(self):
        """ checks load JSON file """
    ...
    def test_dict_to_json(self):
        """ checks dictionary to JSON string """
        s1 = Square(2)
